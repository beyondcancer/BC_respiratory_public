...
for(outcome in outcomes_chronic) {
  ...
  episode <- readRDS(paste0(path_datafiles_for_analysis, "sens5/","cr_episodes_", outcome, "_new_30.rds"))
...
print(results)
saveRDS(results, file = paste0(path_datafiles_for_analysis, "sens5/results_exc_30.rds"))
