...
for(site in cancersites) {
  ...
  for (outcome in outcomes_chronic) {
    ...
    cr_outcome_an <- read.csv(paste0(path_datafiles_for_analysis, "sens2/", site, "_", outcome, "_cr_outcome_an_b5.csv"))
...
saveRDS(results, file = paste0(path_datafiles_for_analysis, "sens2/an_cox_models_first_dx_crude_adj_b5.rds"))
