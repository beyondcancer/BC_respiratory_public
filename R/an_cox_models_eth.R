...
for(site in cancersites) {
  ...
  for (outcome in outcomes_chronic) {
    ...
    covariates <- c("imd5", "bmi", "eth5_hes", "smokstatus","b_asthma", "b_copd", "b_bronch", "b_ild", "b_ckd", "b_hypertension", "b_cvdgrouped", "b_diab_cat", "b_cld", "b_multiple_sclerosis")
    
    factors <- c("age_cat", "imd5", "bmi_cat", "smokstatus", "gender", "eth5_hes")
...
saveRDS(results, file = paste0(path_datafiles_for_analysis, "sens6/an_cox_models_first_dx_crude_adj_eth.rds"))
