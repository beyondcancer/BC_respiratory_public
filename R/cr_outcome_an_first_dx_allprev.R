...
for(site in cancersites) {
  ...
  for (outcome in outcomes_chronic) {
    ...
    file_name <- paste0(path_datafiles_for_analysis, "sens1/", site, "_", outcome, "_cr_outcome_an_allprev.csv")
...
write.csv(population, paste0(path_results, "/first_dx_analysis_numbersallprev_.csv"), row.names = FALSE)
